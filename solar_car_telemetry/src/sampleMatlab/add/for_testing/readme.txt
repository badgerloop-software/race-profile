...
2. Installing the add Package

A. Change to the directory that contains the file setup.py and the subdirectory add. If 
...
3. Using the add Package

The add package is on your Python path. To import it into a Python script or session, 
execute:
